  ...
  return (
    ...
    <div className="flex basis-9/12 justify-center items-center gap-2">
      <div className="freestyler1 basis-5/12">
        {freestyler1 == winner_replica ? <p className="font-medium text-right"><span className='text-violet-700'>* </span>{freestyler1}</p> 
                                        : <p className="font-medium text-right">{freestyler1}</p>}
      </div>
      ...
      {freestyler2 == winner_replica ? <p className="font-medium text-left "><span className='text-violet-700'>* </span>{freestyler2}</p> 
                                        : <p className="font-medium text-left">{freestyler2}</p>}
      </div>
    </div>
  </div>
  )
